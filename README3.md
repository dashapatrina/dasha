...
**Биномиальная куча** — это специальная структура данных, представляющая собой коллекцию биномиальных деревьев.

1. Каждое биномиальное дерево имеет определенный порядок (Bk), определяемый числом узлов 2^k, k — порядок дерева.

2. Биномиальная куча гарантирует, что деревья различного порядка уникальны, а значит, два дерева одного порядка существовать не могут.

3. Минимальный элемент расположен в корне одного из деревьев.

**Основные операции**:
 **Вставка**: Вставка нового элемента создает одиночный узел (биномиальное дерево нулевого порядка), затем производится процедура слияния деревьев с одинаковым порядком.

 **Объединение**: Объединение двух биномиальных куч сводится к процедуре объединения отдельных деревьев разного порядка.
Извлечение минимума: Необходимо найти минимальное значение среди корней деревьев, удалить соответствующий корень и произвести реорганизацию оставшихся деревьев.
